<?php
$app->post('/api/Dota2/getTournamentPlayerStats', function ($request, $response, $args) {
    $settings = $this->settings;

    //checking properly formed json
    $checkRequest = $this->validation;
    $validateRes = $checkRequest->validate($request, ['apiKey', 'accountId']);
    ...
    $query_str = $settings['api_url'] . "/IDOTA2Match_570/GetTournamentPlayerStats/v1";
